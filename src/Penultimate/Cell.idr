...
export
withFg : Cell -> Color -> Cell
withFg cell value = { fg := value } cell

export
withBg : Cell -> Color -> Cell
withBg cell value = { bg := value } cell

export
withAttr : Cell -> Attr -> Cell
withAttr cell attr = { attrs := attr :: cell.attrs } cell
